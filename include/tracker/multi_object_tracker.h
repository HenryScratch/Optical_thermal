...
#ifndef OBJECT_TRACKER_MULTI_OBJECT_TRACKER_H
#define OBJECT_TRACKER_MULTI_OBJECT_TRACKER_H
...
namespace OT {
    ...
    public:
        explicit MultiObjectTracker(cv::Size frameSize,
...
#endif //OBJECT_TRACKER_MULTI_OBJECT_TRACKER_H
